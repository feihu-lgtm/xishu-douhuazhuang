...
// ── 探秘情境 100 种（轻度武侠，不重复上次）──────────────────────────
export const EXP_SCEN = [
  "市井讨价还价", "早市抢货", "夜市捡漏", "与胡商砍价", "当铺赎物",
  "粮行议价", "药铺赊账", "铁匠铺订刀", "布庄换料", "酒坊讨酒",
  "奇遇·老丐传艺", "奇遇·落难客商", "奇遇·隐士指点", "奇遇·捡到头彩", "奇遇·山洪救人",
  "奇遇·古井秘藏", "奇遇·雷劈老树", "奇遇·白狐引路", "奇遇·游方郎中", "奇遇·说书人赠言",
  "劫镖·黑风截道", "护镖·夜走官道", "劫镖·马帮火并", "截胡·夺回赃物", "江湖·擂台赌菜",
  "江湖·厨会斗艺", "江湖·踢馆挑衅", "江湖·恩怨调解", "劫镖·镖银失窃", "江湖·夜探贼巢",
  "探山洞·钟乳滴泉", "下地宫·石门锁阵", "探山洞·暗河渡险", "下地宫·长明灯阵", "探山洞·蝙蝠惊群",
  "下地宫·塌陷逃生", "探山洞·石髓采撷", "下地宫·古墓避毒", "探山洞·一线天光", "下地宫·水牢摸鱼",
  "穿密林·瘴气迷途", "穿密林·兽径追踪", "采山·雨后捡菌", "采山·悬崖采药", "穿密林·藤蔓缠人",
  "采山·雪线寻莲", "穿密林·夜宿山神庙", "采山·溪边网鱼", "穿密林·蜂群夺蜜", "采山·秋风打枣",
  "渡口摆渡", "湖心采菱", "急流放排", "冰面凿鱼", "滩涂赶海",
  "夜钓灯下", "瀑布取泉", "沼泽采藕", "退潮拾贝", "春汛捞鲜",
  "赶集·庙会采买", "端午采艾", "中秋打桂花", "重阳登高采菊", "腊八熬粥备料",
  "年关宰年猪", "春社分肉", "秋收打谷", "冬至包饺子", "上元猜灯谜",
  "拜访·老厨讨教", "拜山·猎户分肉", "走亲戚·带土仪", "送菜·府衙宴", "接风·马帮洗尘",
  "谢师·送束脩", "探病·送药膳", "贺寿·做寿面", "满月·送红蛋", "吊唁·送素席",
  "山火抢收", "风雪封山抢路", "泥石流后寻人", "狼群围村护院", "夜半救火",
  "洪后捞物", "旱年寻水", "雹后抢收", "雾夜迷路", "沙暴避风",
  "行商·走村串户", "以物易物", "赊账收账", "拍卖·头彩竞价", "赶集·摆摊卖菜",
