...
import { FLAVOR_BY_ID, FLAVORS, TECHNIQUES, starLabel, weekLabel, GUESTS } from "./data.js?v=v53";
import { JIANGHU_ROSTER } from "./jianghu.js?v=v53";
import { currentGuest } from "./state.js?v=v53";
...
export function chatContext(st) {
  ...
  return [
    ...
    "【分寸】食评人余味除非师兄主动提起，不得出场、进门或搭话——银簪与名声可以聊，人别写进来。",
  ].filter(Boolean).join("\n");
}
