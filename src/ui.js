...
import { judgeStove, shopStock, currentGuest, affName, SKILLS, rankLabel, CHECK_DIMS, inviteCandidates, findKnownGuest, jianghuInviteCandidates, ryuweiTierName, rivalGuestForSchool, GUESTS_PER_DAY } from "./state.js?v=v53";
import { JIANGHU_ROSTER } from "./jianghu.js?v=v53";
import { loadCfg, saveCfg, listModels, getTrace, clearTrace, fmtMs, rateDots, rateState, getNsfw, setNsfw, MOOD_WORDS } from "./ai.js?v=v53";
import { BGM_TRACKS, bgmState, bgmPlay, bgmPause, bgmToggle, bgmNext, bgmSetVolume, bgmSetLoop, bgmInit } from "./bgm.js?v=v53";
...
export function openWorldMap(st, { onEnter, onExplore }) {
  ...
  const modal = openModal(`
    ...
    <div class="map-body">
      <div class="map-frame">
        <img class="map-img" src="./assets/map_bg_world.webp" alt="">
